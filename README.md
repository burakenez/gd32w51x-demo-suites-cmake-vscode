[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32w51x-demo-suites-cmake-vscode)](https://github.com/burakenez/gd32w51x-demo-suites-cmake-vscode/tags/)

# GD32W51x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32W51x Demo Suites CMake Visual Studio Code** repository! This project is designed to integrate the CMake build system with Visual Studio Code, providing a streamlined development environment for **_GD32W51x Demo Suites V1.4.0_**.
...
- **🧩 Lightweight Templates:** A structured and organized template for GD32W51x microcontroller projects.
...
- **Notes:**
  ...
  - Update paths in these files if necessary:
    - `Projects/<BoardName>/<ProjectName>/.vscode/launch.json` (lines 14, 17):
      ...
      ```
      ```json
      "${workspaceFolder}/../../../Tools/xpack-openocd-0.11.0-3/scripts/target/openocd_gdlink_gd32w51x.cfg"
      ```
...
### 2. **CMSIS/GD/GD32W51x**
- **Version:** `V1.4.0 (2025-01-23)`
- **Path:** `Drivers/CMSIS/GD/GD32W51x`
- Extracted from `GD32W51x Demo Suites V1.4.0`

### 3. **GD32W51x_standard_peripheral**
- **Version:** `V1.4.0 (2025-01-23)`
- **Path:** `Drivers/GD32W51x_standard_peripheral`

### 4. **GD32W51x_usbfs_library**
- **Version:** `V1.4.0 (2025-01-23)`
- **Path:** `Drivers/GD32W51x_usbfs_library`
...
git clone --recursive https://github.com/burakenez/gd32w51x-demo-suites-cmake-vscode.git
```
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32w51x_it.h  # Interrupt handler declarations specific to GD32W51x.
│           │   │   │   ├── gd32w51x_libopt.h  # Library options and configurations for efficient use.
│           │   │   │   └── systick.h  # Definitions and declarations related to the SysTick timer.
│           │   │   ├── Src
│           │   │   │   ├── gd32w51x_it.c  # Interrupt service routine implementations.
│           │   │   │   ├── main.c  # Entry point of the application, containing the main logic and system initialization.
│           │   │   │   ├── system_gd32w51x.c  # System initialization, clock setup, and core configurations.
│           │   │   │   └── systick.c  # SysTick timer setup and related functionalities.
│           │   ├── Startup
│           │   │   └── startup_gd32w51x.s  # Assembly code for initialization and vector table setup.
│           │   ├── User
...
│           ├── Drivers
│           │   ├── BSP/GD32W515P_EVAL  # Board support package configurations and drivers for GD32W515P_EVAL.
│           │   ├── CMSIS  # CMSIS drivers for Cortex-M processors, supporting GD32W51x.
│           │   └── GD32W51x_standard_peripheral  # Peripheral library for GD32W51x.
...
│           ├── gd32w51x_flash.ld  # Linker script for defining memory regions and placements.
│           └── GD32W51x.svd  # System View Description file for debugging and register definitions. 
